   ...
   <section class="content">     
      ...
      <div class="card">
         ...
         <div class="card-body">
            ...
            <form action="" method="post" name="updatestaff" id="updatestaff">                         
               ...
               <div class="row">   
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <input type="text" value="<?php echo $userDetails["email"];?>" name="email" id="email" class="form-control" readonly>
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="form-group">
                        <label>Address</label>
                        <textarea name="address" id="address" class="form-control" rows="2" placeholder="Enter user address."><?php echo $userDetails["address"];?></textarea>
